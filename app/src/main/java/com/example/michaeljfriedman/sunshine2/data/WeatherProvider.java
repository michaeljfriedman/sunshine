...
import com.example.michaeljfriedman.sunshine2.data.WeatherDbHelper;
...
public class WeatherProvider extends ContentProvider {
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        // A null selection will delete all rows, but settings selection to "1" will tell SQLite
        // to return the number of rows deleted so we will actually know
        ...
        // Student: return the rows deleted
        return rowsDeleted;
    }
    ...
    public int update(
        ...
        // Student: Notify the listeners here.
        if (rowsUpdated > 0) {
            getContext().getContentResolver().notifyChange(uri, null);
        }
